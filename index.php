      ...
      <div class="section-modal">
        ...
        <script>
          document.addEventListener('DOMContentLoaded', function() {
            ...
            // Evento para alternar o modal ao clicar no label
            modalLabel.addEventListener('click', function() {
              modalBtn.checked = !modalBtn.checked; // Alterna o estado do checkbox
              toggleModal(); // Atualiza a visibilidade do modal
            });

            // Evento de clique fora do modal para fechar
            document.addEventListener('click', function(event) {
              if (!modal.contains(event.target) && !modalLabel.contains(event.target)) {
        ...
        <li class="noticia">
          ...
          <div class="noticia-txt">
            <div class="noticia-compartilhamento">
              <h4 class="noticia-categoria"> PREVIDENCIARIO |</h4>
            ...
            <a href="#" class="noticia-titulo">
              <h2>Deputados mostram preocupação com diagnóstico precoce com cancer</h2>
            </a>
            ...
            <h6 class="noticia-data">25/06/2024 - 20:08</h6>
          </div>
        </li>
      </div>
        ...
        if ($query->have_posts()) :
          while ($query->have_posts()) : $query->the_post();
            ...
            if (get_the_post_thumbnail_url()) {
              ...
              $thumbnail_url = get_template_directory_uri() . '/assets/img/post-imgblog.webp';
            }
        ?>
            ...
            <li class="noticia">
              <div class="noticia-img">
                <a href="<?php the_permalink(); ?>">
                  <img class="noticia-thumbnail" src="<?php echo $thumbnail_url; ?>" alt="">
                </a>
              </div>
              <div class="noticia-txt">
                <div class="noticia-compartilhamento">
